...
| **P1** | **臂 A**:`official_full` + 同数据同配方 4000 步(`--ref_isolation False`) | ~6 h | ~~配方有毒 vs 学生有病~~(已由表 ③ 答:配方无毒)⇒ 现在测**底座 gap 的大小**;并标定判据在真实条件下的可达性 | **[2026-08-03 确认点 5] 排第 1,下一个上机的就是它**。不受 P-probe 影响:臂 A 全程 `ref_isolation False`,与隔离结构无关 |
